...
seed_demo_products, seed_demo_delivery_settings, seed_demo_orders, seed_demo_reservations,
and seed_demo_waiting_list for it. Deploy runs this after migrations so that:
