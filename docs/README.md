...
| [0027-amvara9-menu-images-troubleshooting.md](0027-amvara9-menu-images-troubleshooting.md) | amvara9 public menu/catalog image 404s on `/api/uploads/…`: explicit upload routes vs missing-on-disk; verify and SSH checks. |
